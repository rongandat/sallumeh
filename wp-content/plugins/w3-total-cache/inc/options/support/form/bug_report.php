...
<table class="form-table">
    ...
    <tr>
        <th><label for="support_wp_login"><?php _e('<acronym title="WordPress">WP</acronym> Admin login:</label>', 'w3-total-cache'); ?></th>
        <td><input id="support_wp_login" type="text" name="wp_login" value="<?php echo esc_attr($wp_login); ?>" size="80" /></td>
    </tr>
    <tr>
        <th><label for="support_wp_password"><?php _e('<acronym title="WordPress">WP</acronym> Admin password:</label>', 'w3-total-cache'); ?></th>
    ...
    <tr>
        <td colspan="2">
            <input id="support_subscribe_releases" name="subscribe_releases" type="checkbox" value="<?php _e('Yes', 'w3-total-cache'); ?>" <?php checked($subscribe_releases, true) ?> /> <?php _e('Yes, please notify me.', 'w3-total-cache'); ?>
        </td>
    </tr>
</table>
<?php echo $this->postbox_footer(); ?>