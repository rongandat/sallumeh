...
<div id="order_review">
	...
	<table class="shop_table" border="0" cellpadding="0" cellspacing="0">
		<thead>
			<tr>
				<th width="180" class="product-name"><?php _e( 'Product', 'woocommerce' ); ?></th>
				<th width="180" class="product-total"><?php _e( 'Total', 'woocommerce' ); ?></th>
			</tr>
		</thead>
