...
<div class="checkout">
    <table class="shop_table order_details" border="0" cellpadding="0" cellspacing="0" >
        <thead>
            <tr>
        ...
        <tbody>
            ...
            if ($totals = $order->get_order_item_totals())
                foreach ($totals as $total) :
                    ?>
                    <tr>
                        <th width="200" scope="row"><?php echo $total['label']; ?></th>
                        <td width="200" ><?php echo $total['value']; ?></td>
                    </tr>
                    <?php
                endforeach;
            ?>
